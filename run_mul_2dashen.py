...
if __name__ == '__main__':
    ...
    if sel == '4' or sel == '5' or sel == '6' or sel == '7' or sel=='9':
        win_rect_mul_leftedge_dashen = get_Edge_window_rect(hwnd_title,'大神云游戏')
    if sel == '5' or sel == '7' or sel=='9':
        win_rect_mul_rightgoogle_dashen = get_Chrome_window_rect(hwnd_title,'大神云游戏')
    ...
    while True:
        ...
        if (content_countdown!=None) and len(content_countdown) > 0 and content_countdown[0].isdigit():
            ...
            if len(content_continue)>0 and content_continue[0] == '点击继续':
                ...
                if sel == '4' or sel == '5' or sel == '6' or sel == '7' or sel =='9':
                    x, y = 747,830
                    left_click(win_rect_mul_leftedge_dashen[0]+x,win_rect_mul_leftedge_dashen[1]+y+padd2wy,4)
                if sel == '5' or sel == '7' or sel =='9':
                    x, y = 747,830
            ...
            if sel == '1' or sel == '4' or sel == '5' or sel == '6' or sel == '7' or sel == '8' or sel =='9': # 魔法史
                ...
                if flag0 or flag1 or flag2 or flag3: # 识别到了就跳过，重新截图
                    ...
                    if sel == '4' or sel == '5' or sel == '6' or sel == '7' or sel =='9':
                        x, y = 800,800
                        left_click(win_rect_mul_leftedge_dashen[0]+x,win_rect_mul_leftedge_dashen[1]+y+padd2wy,1)
                    if sel == '5' or sel == '7' or sel =='9':
                        x, y = 800,800
        ...
        if countdown_num == time_chutdown:
            ...
            if len(res) >0:
                ...
                if sel == '4' or sel == '5' or sel == '6' or sel == '7' or sel =='9':
                    ...
                    left_click(win_rect_mul_leftedge_dashen[0]+x,win_rect_mul_leftedge_dashen[1]+y+padd2wy,2)
                if sel == '5' or sel == '7' or sel =='9':
                    x,y = coordinate_mul[res[0][2]][0], coordinate_mul[res[0][2]][1]
